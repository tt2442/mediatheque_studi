 ...
 */
final class Version20211021095228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD COLUMN reserve BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(255) NOT NULL, disponible BOOLEAN NOT NULL, titre VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, date DATE NOT NULL, description VARCHAR(255) NOT NULL, auteur VARCHAR(255) NOT NULL)');
